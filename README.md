...
This repository is part of an ongoing project that utilizes Path Sampling (PS) model selection, Bayesian Evaluation of Temporal Signal (BETS), Markov Chain Monte Carlo (MCMC) simulations, and phylogenetic analyses to unravel the mechanisms driving the spread and persistence of the HRTV in Georgia's ecosystem.
...
[S4 BETS analysis.xlsx](https://github.com/user-attachments/files/20991260/S4.BETS.analysis.xlsx)
[S5 Model testing.xlsx](https://github.com/user-attachments/files/20991261/S5.Model.testing.xlsx)
